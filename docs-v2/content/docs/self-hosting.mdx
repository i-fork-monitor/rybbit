...
<Step>
### Get a Mapbox Token (Optional but Recommended)

To enable <a href="https://demo.rybbit.io/21/globe" target="_blank">globe visualizations</a> in Rybbit, you'll need a Mapbox API token:
